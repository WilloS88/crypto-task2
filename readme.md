...
This project is part of the Cryptology course. It includes Playfair cipher implemented in TypeScript.
...
2. **Clone the Repository**: Clone the project repository to your local machine using the following command:
  ```sh
  git clone https://github.com/WilloS88/crypto-task2.git
  ```
